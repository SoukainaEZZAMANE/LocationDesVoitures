...
catch (Exception $e) // Si erreur
{
 ...
 $req= $bdd->query("SELECT * FROM voiture where categorie='Citadine'"); // Je choisis de la base de donné login le champ login
...
<p><button style="text-shadow: 1px 1px 10px #CDBE9F, 0 0 1.3em #BEAE8C, 0 0 0.2em #b6a684;padding: 5px 10px 6px;background:    -moz-linear-gradient(#cccccc,#999999);color: white;text-align:center;font: 2em 'Tempus Sans ITC';font-weight:bold;font-size:20px;display: inline-block;padding: 5px 10px 6px;cursor: pointer;" >Réserver</button></p>
</form>
<?php
echo '</div>';
}
